...
class InsertState extends StateAbstract {
    ...
    public function render()
    {
        ...
        if (!$validator->validate()) {
            ...
            $relation1to1Data = $this->getRelation1to1Data($addFields, $stateParameters->data);
            ...
            $operationResponse = $this->stateOperationWithCallbacks($stateParameters, 'Insert', function ($stateParameters) use ($relationNtoNData, $relation1to1Data) {
                $model = $this->gCrud->getModel();
